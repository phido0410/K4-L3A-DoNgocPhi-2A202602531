...
class EmbeddingStore:
    ...
    def __init__(
        ...
        # In-memory only (per lab guidance): no test needs ChromaDB, and enabling it
        # on a machine that happens to have chromadb installed would change behaviour.
    ...
    def _make_record(self, doc: Document) -> dict[str, Any]:
        ...
        # delete_document() relies on doc_id; default it to the document's own id.
    ...
    def search_with_filter(self, query: str, top_k: int = 3, metadata_filter: dict = None) -> list[dict]:
        ...
        # Pre-filter: only matching chunks compete for the top_k slots.
        candidates = [
            record
